...
Use this space for quick experiments, reproducible QA probes, and one-off checks, like validating fact grain and referential integrity, recomputing usage and billing metrics, and tracking row flow across layers.
